...
if __name__ == '__main__':
    ...
    dataset = "qmsum"
    hypo_file_name = 'test.reference'
    test_file_name = 'test_results/qmsum_dual_24_12_sort_rerank.results'
    # dataset = "AMI"
    # hypo_file_name = 'test_label_stage2_0.7_beam4.hypo'
    # test_file_name = 'test_reform.target'
    ref = readline_aslist("./data/{}/{}".format(dataset, test_file_name))
    hypo = readline_aslist("./data/{}/{}".format(dataset, hypo_file_name))

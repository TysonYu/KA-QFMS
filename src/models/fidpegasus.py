...
from models.modeling_pegasus import PegasusForConditionalGeneration
from models.modeling_pegasus import PegasusEncoderLayer
from models.modeling_pegasus import _expand_mask
...
class PegasusForMultiConditionalGeneration(PegasusForConditionalGeneration):
    def __init__(self, config, args):
        ...
        if self.args.knowledge_aware == 'multihead':
            ...
            self.global_attention = PegasusEncoderLayer(config)
            pass
